...
local globalKeys =
  ...
  awful.key({ modkey, "Shift"   }, "j",
    ...
    { description = 'swap next' }
  ),
  awful.key({ modkey, "Shift"   }, "k",
    function()
      awful.client.swap.byidx( -1)
    end,
    { description = 'swap previous' }
  ),
  ...
  awful.key({                   }, "XF86TouchpadToggle",
    function()
      awful.spawn("/usr/local/bin/touchpad.sh", false)
    end,
    {description = 'toggle touchpad', group = 'client'}
  ),
  ...
  awful.key(
    ...
    {description = 'toggle logout menu', group = 'hotkeys'}
  ),

  -- Custom apps and shortcuts
  ...
  awful.key({ modkey,           }, "b",
    function()
      awful.spawn("firefox --no-remote -P")
    end
  )
)
